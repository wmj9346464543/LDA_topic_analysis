...
output_path = os.path.join(current_path, 'lda', 'result')

file_path = os.path.join(current_path, 'lda', 'data')
os.chdir(file_path)
data=pd.read_excel("data.xlsx")#content type
os.chdir(output_path)
dic_file = os.path.join(current_path, 'lda', 'stop_dic', 'dict.txt')
stop_file = os.path.join(current_path, 'lda', 'stop_dic', 'stopwords.txt')
